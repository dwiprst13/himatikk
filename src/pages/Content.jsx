...
function Content() {
  ...
  return (
    <main className="w-full">
      <section
        id="banner"
        className="bg-[/hero.png')] bg-cover h-screen w-full flex items-center bg-fixed"
      >
      ...
      <section
        id="sejarah"
        ref={sejarahRef}
        className="bg-[/mahasiswa.jpg')] bg-cover h-[75vh] md:h-[100vh] w-full flex items-center bg-fixed"
      >
        <div className="">
          <Sejarah />
        </div>
